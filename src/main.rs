...
pub struct TopLevel {
    ...
    #[argh(option, long = "fs")]
    /// tag=<tag_name>,socket=<socket_path>,num_queues=<number_of_queues>,queue_size=<size_of_each_queue>,id=<device_id>,pci_segment=<segment_id>,inline=<inline>,source_path=<source_path>,mount_path=<mount_path>,dax=<dax>,cache_size=<cache_size>
    fs: Vec<String>,
